...
* The energy balance between generation and loads must be lower than the grid capacity $GC_t$:

$$
O_t + LS_t - G_t \le GC_t \quad t \in T
$$
...
* The imported energy must remain between 0 and the corresponding energy consumed with the maximum grid capacity $GC_t$:
